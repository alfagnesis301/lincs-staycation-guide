...
export const towns: Town[] = [
  ...
  },
  {
    ...
    description: 'A riverside town in West Lindsey with Gainsborough Old Hall, a notably well-preserved medieval manor house.',
    extendedDescription: [
