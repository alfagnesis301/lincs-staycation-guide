...
export const townGuideProfiles: Record<string, TownGuideProfile> = {
  lincoln: {
    ...
    attractions: [
      { name: 'Lincoln Cathedral', category: 'Historic site', description: 'The city landmark and a core reason to visit Lincoln; check services, visitor access and event closures before travelling.', tags: ['Cathedral', 'Architecture', 'Heritage'], needsVerification: v },
      { name: 'Lincoln Castle', category: 'Historic site', description: 'A major heritage site for castle walls, Magna Carta context, prison history and city views.', tags: ['Castle', 'History', 'Family-friendly'], needsVerification: v },
      ...
      { name: 'Museum of Lincolnshire Life', category: 'Museum', description: 'A useful rainy-day stop for local social, industrial and military history.', tags: ['Museum', 'Rainy day', 'Local history'], needsVerification: v },
      { name: 'The Collection / Usher Gallery', category: 'Museum', description: 'Indoor archaeology, art and culture close to the historic centre.', tags: ['Gallery', 'Museum', 'Rainy day'], needsVerification: v },
      { name: 'International Bomber Command Centre', category: 'Heritage', description: 'A major aviation and remembrance site just outside the city centre.', tags: ['Aviation', 'Heritage', 'Memorial'], needsVerification: v },
    ],
    practicalTips: [
  ...
  skegness: {
    ...
    attractions: [
      ...
      { name: 'Skegness Pier and arcades', category: 'Entertainment', description: 'Traditional family entertainment, games and seaside amusements close to the beach.', tags: ['Pier', 'Arcades', 'Rainy day'], needsVerification: v },
      { name: 'Natureland Seal Sanctuary', category: 'Wildlife', description: 'A family-friendly wildlife stop best checked directly for current visitor information.', tags: ['Wildlife', 'Family-friendly'], needsVerification: v },
      { name: 'Gibraltar Point National Nature Reserve', category: 'Nature', description: 'A quieter coastal landscape for birdwatching, walking and big skies south of the resort.', tags: ['Nature', 'Walk', 'Wildlife'], needsVerification: v },
      { name: 'Fantasy Island, Ingoldmells', category: 'Family-friendly', description: 'A major nearby family attraction for rides, markets and holiday park visitors.', tags: ['Nearby', 'Family-friendly', 'Entertainment'], needsVerification: v },
  ...
  stamford: {
    ...
    attractions: [
      ...
      { name: 'Burghley House', category: 'Historic site', description: 'A major Elizabethan house and one of the strongest reasons to build a Stamford weekend.', tags: ['Historic house', 'Heritage', 'Garden'], needsVerification: v },
      ...
      { name: 'Stamford Arts Centre', category: 'Rainy day', description: 'A central culture stop for cinema, theatre, exhibitions and indoor plans.', tags: ['Arts', 'Rainy day', 'Culture'], needsVerification: v },
  ...
  louth: {
    ...
    attractions: [
      { name: 'St James\'s Church', category: 'Historic site', description: 'The town landmark and a useful orientation point for Louth\'s historic centre.', tags: ['Church', 'Heritage', 'Architecture'], needsVerification: v },
      ...
      { name: 'Hubbard\'s Hills', category: 'Nature', description: 'A wooded valley walk close to town and one of the easiest outdoor wins for visitors.', tags: ['Walk', 'Nature', 'Family-friendly'], needsVerification: v },
      ...
      { name: 'Cadwell Park nearby', category: 'Entertainment', description: 'A motorsport add-on near Louth; check event calendars before planning around it.', tags: ['Motorsport', 'Nearby', 'Events'], needsVerification: v },
    ],
    practicalTips: [
  ...
  boston: {
    ...
    attractions: [
      { name: 'St Botolph\'s Church / Boston Stump', category: 'Historic site', description: 'Boston\'s landmark tower and a central anchor for any heritage visit.', tags: ['Church', 'Heritage', 'Landmark'], needsVerification: v },
      { name: 'Boston Guildhall', category: 'Museum', description: 'A key stop for Pilgrim Fathers context and town history.', tags: ['Museum', 'Pilgrim history', 'Rainy day'], needsVerification: v },
      ...
      { name: 'Maud Foster Windmill', category: 'Heritage', description: 'A distinctive working windmill landmark close to the town centre.', tags: ['Windmill', 'Heritage', 'Food'], needsVerification: v },
      { name: 'RSPB Frampton Marsh', category: 'Wildlife', description: 'A major wetland reserve for birds, walking and big fenland skies.', tags: ['Wildlife', 'Nature', 'Birdwatching'], needsVerification: v },
      { name: 'Freiston Shore', category: 'Nature', description: 'A quieter coastal reserve for wildlife and Wash-side walks.', tags: ['Nature', 'Wildlife', 'Walk'], needsVerification: v },
    ],
    practicalTips: [
  ...
  grantham: {
    ...
    attractions: [
      { name: 'Belton House', category: 'Historic site', description: 'A major National Trust country house and one of Grantham\'s strongest visitor draws.', tags: ['Country house', 'Garden', 'Family-friendly'], needsVerification: v },
      { name: 'St Wulfram\'s Church', category: 'Historic site', description: 'A landmark church with a striking spire and strong town-centre presence.', tags: ['Church', 'Heritage', 'Architecture'], needsVerification: v },
      { name: 'Grantham Museum', category: 'Museum', description: 'A compact stop for local history and Grantham\'s Newton and Thatcher connections.', tags: ['Museum', 'Rainy day', 'Local history'], needsVerification: v },
      { name: 'Woolsthorpe Manor nearby', category: 'Heritage', description: 'Isaac Newton\'s birthplace and a major science-history day trip from Grantham.', tags: ['Newton', 'Nearby', 'Heritage'], needsVerification: v },
      { name: 'Belvoir Castle nearby', category: 'Historic site', description: 'A dramatic estate and castle day out west of Grantham.', tags: ['Castle', 'Day trip', 'Garden'], needsVerification: v },
  ...
  spalding: {
    ...
    attractions: [
      { name: 'Ayscoughfee Hall', category: 'Museum', description: 'A historic hall and gardens that anchor Spalding\'s visitor offer.', tags: ['Museum', 'Garden', 'Heritage'], needsVerification: v },
      ...
      { name: 'Springfields Outlet & Festival Gardens', category: 'Shopping', description: 'A shopping and garden stop with strong appeal for easy day trips.', tags: ['Shopping', 'Garden', 'Family-friendly'], needsVerification: v },
  ...
  sleaford: {
    ...
    attractions: [
      ...
      { name: 'The Hub / National Centre for Craft & Design', category: 'Museum', description: 'A key cultural venue for craft, design, exhibitions and indoor plans.', tags: ['Craft', 'Design', 'Rainy day'], needsVerification: v },
      { name: 'Sleaford Museum', category: 'Museum', description: 'A local-history stop for visitors who want town context.', tags: ['Museum', 'Local history', 'Rainy day'], needsVerification: v },
      ...
      { name: 'Heckington Windmill nearby', category: 'Heritage', description: 'A distinctive eight-sailed windmill and useful add-on from Sleaford.', tags: ['Windmill', 'Nearby', 'Heritage'], needsVerification: v },
    ],
    practicalTips: [
  ...
  mablethorpe: {
    ...
    attractions: [
      ...
      { name: 'Mablethorpe Seal Sanctuary', category: 'Wildlife', description: 'A popular wildlife attraction; check current opening and animal-care information before visiting.', tags: ['Wildlife', 'Family-friendly'], needsVerification: v },
      ...
      { name: 'Lincolnshire AquaPark', category: 'Family-friendly', description: 'A nearby active attraction for older children and groups; confirm season and booking rules.', tags: ['Aqua park', 'Seasonal', 'Family-friendly'], needsVerification: v },
  ...
  'woodhall-spa': {
    ...
    attractions: [
      { name: 'Kinema in the Woods', category: 'Entertainment', description: 'A characterful heritage cinema and one of the village\'s signature visitor experiences.', tags: ['Cinema', 'Rainy day', 'Heritage'], needsVerification: v },
      { name: 'Jubilee Park', category: 'Family-friendly', description: 'A central park and seasonal leisure focus for families and relaxed village days.', tags: ['Park', 'Family-friendly', 'Outdoor'], needsVerification: v },
      { name: 'Woodhall Spa Cottage Museum', category: 'Museum', description: 'A small local-history museum explaining the village\'s spa heritage.', tags: ['Museum', 'Local history', 'Rainy day'], needsVerification: v },
      ...
      { name: 'Petwood Hotel heritage', category: 'Heritage', description: 'Known for its Dambusters associations; check public access and displays before visiting.', tags: ['Aviation', 'Hotel heritage', 'History'], needsVerification: v },
  ...
  horncastle: {
    ...
    attractions: [
      ...
      { name: 'Joseph Banks Centre', category: 'Museum', description: 'A heritage and learning stop linked to the botanist Sir Joseph Banks.', tags: ['Museum', 'Heritage', 'Rainy day'], needsVerification: v },
      ...
      { name: 'Cadwell Park nearby', category: 'Entertainment', description: 'A motorsport day out within reach; check event calendars before travelling.', tags: ['Motorsport', 'Nearby', 'Events'], needsVerification: v },
  ...
  gainsborough: {
    ...
    attractions: [
      { name: 'Gainsborough Old Hall', category: 'Historic site', description: 'One of the strongest medieval heritage sites in Lincolnshire and the key visitor anchor.', tags: ['Historic house', 'Medieval', 'Heritage'], needsVerification: v },
      ...
      { name: 'Trinity Arts Centre', category: 'Entertainment', description: 'A useful culture and rainy-day option; check current programme before visiting.', tags: ['Arts', 'Rainy day', 'Entertainment'], needsVerification: v },
  ...
  'market-rasen': {
    ...
    attractions: [
      { name: 'Market Rasen Racecourse', category: 'Entertainment', description: 'The town\'s headline attraction and a strong reason to plan a timed visit.', tags: ['Racing', 'Events', 'Day out'], needsVerification: v },
  ...
  bourne: {
    ...
    attractions: [
      { name: 'Bourne Woods', category: 'Nature', description: 'The strongest outdoor draw, with woodland trails suited to walking and family exploring.', tags: ['Woodland', 'Walk', 'Family-friendly'], needsVerification: v },
      ...
      { name: 'Grimsthorpe Castle nearby', category: 'Historic site', description: 'A major nearby estate for castle, gardens, parkland and seasonal events.', tags: ['Castle', 'Garden', 'Nearby'], needsVerification: v },
