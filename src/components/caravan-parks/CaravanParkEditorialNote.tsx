...
const DEFAULT_TEXT =
  'These entries are included as practical comparison notes, not paid rankings. Facilities, prices, pet policies, opening dates and booking availability can change. Please check directly with each business before planning your trip.';
